...
# My PR has been merged and can now be used directly
# No need to customize, if you want to customize, you can refer to it.
...
# SPACESHIP_COMMIT_HASH_PREFIX="${SPACESHIP_COMMIT_HASH_PREFIX=""}"
